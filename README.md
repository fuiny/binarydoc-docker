...
With the pre-configured [BinaryDoc Docker](https://github.com/fuiny/binarydoc-docker-compose/blob/master/docker-compose.yml "Pre-configured Docker Compose file") we can use this tool to genereate documents and diagrams in own environment, and here is the [user guide](https://github.com/fuiny/binarydoc-docker-compose "User Guide") on the steps.
